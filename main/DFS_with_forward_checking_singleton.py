...
def solve_problem(state,country,country_colors):
    ...
    for i in range(len(b[state])):
        ...
        #print("singleton value", singleton)
...
def main():
    ...
    x = input("1. Backtracking with Forward checking\n 2. Backtracking with forward checking and singleton\n ")
    global singleton
    if (x == '1'):
        if (solve_problem(WV,united_states_of_america,us_colors)):
